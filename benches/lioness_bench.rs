...
pub fn lioness_bench(c: &mut Criterion) {
    ...
    group.bench_function("lioness_encrypt", |b| {
        ...
        hopr_types::crypto_random::random_fill(&mut k);
        hopr_types::crypto_random::random_fill(&mut iv);

        let lioness = hopr_types::crypto::lioness::LionessBlake3ChaCha20::<BlockSize>::new(&k, &iv);
