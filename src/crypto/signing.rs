...
use crate::primitive::prelude::{GeneralError::ParseError, *};
use sha2::Sha512;
...
impl<E: EcdsaEngine> ChainSignature<E> {
    ...
    pub fn verify_message(
        ...
        message: &[u8],
        public_key: &PublicKey,
    ) -> crate::crypto::errors::Result<bool> {
    ...
    #[inline]
    pub fn recover_from_msg(&self, msg: &[u8]) -> crate::crypto::errors::Result<PublicKey> {
    ...
    pub fn recover_from_hash(&self, hash: &Hash) -> crate::crypto::errors::Result<PublicKey> {
...
mod tests {
    ...
    use super::*;
    use crate::crypto::keypairs::Keypair;
