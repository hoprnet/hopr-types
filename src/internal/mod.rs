...
//! As opposed to the `primitive` module, which contains more generic types (not necessarily specific only to HOPR).
//!
...
//! to understand the decisions on types defined in this module.
