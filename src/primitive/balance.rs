...
impl<C: Currency> UnitaryFloatOps for Balance<C> {
    fn mul_f64(&self, rhs: f64) -> crate::primitive::errors::Result<Self> {
        self.0.mul_f64(rhs).map(|x| Self(x, C::default()))
    }

    fn div_f64(&self, rhs: f64) -> crate::primitive::errors::Result<Self> {
...
mod tests {
    ...
    use super::*;
    use crate::primitive::primitives::U256;
